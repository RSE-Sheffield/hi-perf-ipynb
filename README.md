...
1. [Parallelisation using packages that support multithreading](tutorials/01-multithreading.ipynb)
1. [Parallelising your own code using multiple Python processes on a single machine](tutorials/02-multiprocessing.ipynb)
